...
function Optimize-SingleCard {
    ...
    Write-Host "Optimized (512x512): $([System.IO.Path]::GetFileName($fullPath)) in $([System.IO.Path]::GetDirectoryName($fullPath))"
}

# cards_ssr と cards_items の全画像を最適化
$folders = @("src/assets/images/cards_ssr", "src/assets/images/cards_items")
...
Write-Host "Successfully optimized all SSR and Item cards!"
