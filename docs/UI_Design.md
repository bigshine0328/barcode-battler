...
- **バージョン**: `v3.0.0` (Comprehensive UI Specification with Level & EXP Growth System)
- **最終更新日**: 2026年8月15日
- **作成/改定担当**: `ux-engineer`
...
- メイン出撃キャラカード展示（大迫力SVG、名前、属性タグ、SSRレアリティバッジ、ステータス）
...
| 👇 カードをタップで詳細・EXP確認・セット・削除  |
| +---------------------+   +---------------------+ |
| | ✅DECK   [⚔️メイン] |   | ✅DECK    [🛡️サブ1] | |
| | (Mini-SVG)          |   | (Mini-SVG)          | |
| | Lv.15 爆炎ドラゴン  |   | Lv.12 迅雷タイガー  | |
| | [火] HP1480 ATK220  |   | [水] HP1200 ATK180  | |
| +---------------------+   +---------------------+ |
| +---------------------+   +---------------------+ |
| | ✅DECK  [💊アイテム1]|   | ✅DECK  [💊アイテム2]| | (★3種同時ハイライト)
| | (Mini-SVG)          |   | (Mini-SVG)          | |
